<?php if(!@defined('_lib')) die("Error");
	...
	#========= Thông tin nhân viên ==============
	@define ( _contact_email , "info@danangweb.vn" );
	@define ( _contact_yahoo , "" );
	@define ( _contact_skype , "" );
	@define ( _contact_phone , "0167.412.5176" );	
	...
	@define ( _upload_binhluan , '../upload/binhluan/' );
	@define ( _upload_binhluan_l , 'upload/binhluan/' );
