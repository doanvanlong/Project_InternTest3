...
<?php	
	function get_main_danhmuc()
	{
		...
		$str='
			<select id="id_danhmuc" name="id_danhmuc" data-placeholder="Chọn danh mục" onchange="select_onchange()" class="main_select select_danhmuc chzn-select">
	...
	function get_main_list()
	{
		...
		$result=mysql_query($sql_huyen);
		$str='
			<select id="id_list" name="id_list" data-placeholder="Chọn danh mục" onchange="select_onchange1()" class="main_select select_danhmuc chzn-select">
...
<div id="div_fixed">
  ...
  <a href="index.php?com=product&act=man_cat<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='.$_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-warning" original-title="Thoát"><i class="fa fa-warning"></i>&nbsp;Thoát</a>
</div>
          ...
          <div class="photoUpload-zone">
            ...
            <div class="photoUpload-detail" id="photoUpload-preview"><img class="rounded" src="<?=_upload_sanpham.$item['photo']?>" onerror="src='images/noimage.png'" alt="Alt Photo"/><div class="none">Hình hiện tại</div>
              ...
              <div class="detailImages">
                ...
                <div class="btn">
                  <div class="removeInput" data-id="<?=$item["id"]?>" data-photo="<?=$item["photo"]?>" data-format="<?=_upload_sanpham?>" data-table="product_cat" data-field="photo"><a class="icon-jfi-trash jFiler-item-trash-action"></a></div>
                </div>
              </div>
            </div>
          </div>
