...
<button type="button" class="btn btn-info" onclick="TreeFilterChanged2(); return false;"><i class="fa fa-check-circle"></i>&nbsp;Hoàn tất</button>
  ...
  <a href="index.php?com=product&act=man_danhmuc<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='.$_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-warning" original-title="Thoát"><i class="fa fa-warning"></i>&nbsp;Thoát</a>
</div>
...
<div class="widget mt-10">
  <div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
   ...
   <div id="info" class="tab_content">
    ...
    <div class="myrow">
      <div class="mycol-6 mycol-table-6 mycol-mobi-12 <?= (!$config_s['logo'])?'none':'' ?>">
      <div class="formRow ">
        <label>Hình ảnh Logo:</label>
        <div class="formRight">
          <div class="photoUpload-zone">
            <div class="photoUpload-dimension"><?=$config_s['size_logo']?>  <?=_format_duoihinh_l?></div>
            <label class="photoUpload-file" id="photo-logo" for="file-logo" style="border: none; background:none;padding: 0px; display: inherit;">
              <input type="file" name="file1" id="file-logo">
              <!--<i class="fa fa-cloud-upload"></i>
              <p class="photoUpload-drop">Kéo và thả hình vào đây</p>
              <p class="photoUpload-or">hoặc</p>-->
              <div class="photoUpload-choose btn btn-info">+ Tải ảnh logo lên</div>
            </label>
            <div class="photoUpload-detail" id="logoUpload-preview"><img class="rounded" src="<?=_upload_sanpham.$item['logo']?>" onerror="src='images/noimage.png'" alt="Alt Photo"/><div class="none">Hình hiện tại</div>
              <?php
                $file_size = filesize($_SERVER['DOCUMENT_ROOT']."/"._upload_sanpham_l.$item['logo']); // Get file size in bytes
              ...
              <div class="detailImages">
                ...
                <div class="btn">
                  <div class="removeInput" data-id="<?=$item["id"]?>" data-photo="<?=$item["logo"]?>" data-format="<?=_upload_sanpham?>" data-table="product_danhmuc" data-field="logo"><a class="icon-jfi-trash jFiler-item-trash-action"></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="photoUpload-zone">
              ...
              <div class="photoUpload-detail" id="photoUpload-preview"><img class="rounded" src="<?=_upload_sanpham.$item['photo']?>" onerror="src='images/noimage.png'" alt="Alt Photo"/><div class="none">Hình hiện tại</div>
                ...
                <div class="detailImages">
                  ...
                  <div class="btn">
                    <div class="removeInput" data-id="<?=$item["id"]?>" data-photo="<?=$item["photo"]?>" data-format="<?=_upload_sanpham?>" data-table="product_danhmuc" data-field="photo"><a class="icon-jfi-trash jFiler-item-trash-action"></a></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="formRow ">
     ...
     <div class="formRow   <?=(!$config_s['noibat_tc'])?'none':''?>">
          <label>Nổi bật Trang chủ: <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này ! "> </label>

         <div class="formRight">
            <input type="checkbox" name="noibat_tc" id="check2" <?=(!isset($item['noibat_tc']) || $item['noibat_tc']==1)?'checked="checked"':''?> />
            </div>
			   <div class="clear"></div>
      </div>
      <div class="formRow">
        ...
        <div class="formRight">
          ...
          <input type="checkbox" name="hienthi" id="check3" <?=(!isset($item['hienthi']) || $item['hienthi']==1)?'checked="checked"':''?> />
