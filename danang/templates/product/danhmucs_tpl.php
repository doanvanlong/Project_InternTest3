...
<div class="control_frm" style="margin-top:0;">
  <div id="div_fixed">
      <input type="button" class="btn btn-info" value="Thêm" onclick="location.href='index.php?com=product&act=add_danhmuc&type=<?=$_REQUEST['type']?>'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr class="tt_table">
        ...
        <td class="tb_data_small <?=(!$config_s['noibat_tc'])?'none':''?>">Nổi bật trang chủ</td>
   ...
   <tr>
        ...
        <td align="center" class=" <?=(!$config_s['noibat_tc'])?'none':''?>">
        	<a data-val2="table_<?=$_GET['com']?>_danhmuc" rel="<?=$items[$i]['noibat_tc']?>" data-val3="noibat_tc" class="diamondToggle <?=($items[$i]['noibat_tc']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
        <td align="center">
        ...
        <td class="actBtns">
            <a href="index.php?com=product&act=edit_danhmuc&type=<?=$_REQUEST['type']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="btn btn-info" original-title="Sửa sản phẩm"><i class="fa fa-pencil"></i> Sửa</a>
