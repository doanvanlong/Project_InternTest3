...
$(document).ready(function() {
	...
	$("#xoahet").click(function(){
		...
		if (hoi==true) document.location = "index.php?com=newsletter&act=delete<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>&listid=" + listid;
	});
	});
...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
			...
			<?php }  else { ?>
            	<li class="current"><a href="#" onclick="return false;">Quản lý thông tin</a></li>
            <?php } ?>
        </ul>
        <div class="clear"></div>
    </div>
...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=newsletter&act=add<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'" />
...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
		...
		<td class="sortCol none"><div>Nội dung<span></span></div></td>
	...
	<tr style="text-align:center">
		...
		<td  style="width:10%;" class="" align="center"><b><?=$items[$i]['name']?></b></td>
        <td  style="width:10%;" class="" align="center"><b><?=$items[$i]['phone']?></b></td>
		<td  style="width:20%;" align="center"><b><?=$items[$i]['email']?></b></td>
        <td  style="width:20%;" class="none" align="center"><b><?=$items[$i]['content']?></b></td>
		<td style="width:20%;">
        <a class="none" href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST['type']?>" class="smallButton tipS" original-title="Sửa mail"><img src="./images/icons/dark/pencil.png" alt=""></a>
        <a href="index.php?com=newsletter&act=delete&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST['type']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="./images/icons/dark/close.png" alt=""></a></td>
