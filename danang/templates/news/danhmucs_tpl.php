...
<div class="control_frm " style="margin-top:0;">
  	<div id="div_fixed">
    	<input type="button" class="btn btn-info" value="Thêm" onclick="location.href='index.php?com=news&act=add_danhmuc&type=<?=$_REQUEST['type']?>'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      <thead>
      <tr class="tt_table">
        <td><div class="titleIcon buttonCheckALl"><input type="checkbox" id="titleCheck" name="titleCheck" /></div></td>
   ...
   <tr>
        ...
        <td class="actBtns">
           <a href="index.php?com=news&act=edit_danhmuc&type=<?=$_REQUEST['type']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="btn btn-info" original-title="Sửa sản phẩm"><i class="fa fa-pencil"></i> Sửa</a>
