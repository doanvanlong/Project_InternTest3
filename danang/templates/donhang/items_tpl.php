...
<div class="control_frm" >
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            <li><a href="index.php?com=order&act=man&type="><span>Đơn hàng</span></a></li>
  ...
  <div class="titlee">
    ...
    <form name="search" action="index.php" method="GET" class="form giohang_ser">
    	...
    	<div class="myrow">
    		...
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10"><input class="w-100" name="keyword" placeholder="Nhập từ khóa.." value="<?=$_GET['keyword']?>" type="text" /></div>
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10"><input class="w-100" name="ngaybd" id="datefm" type="text" value="<?=$_GET['ngaybd']?>" placeholder="Từ ngày.."/></div>
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10"><input class="w-100" name="ngaykt" id="dateto" type="text" value="<?=$_GET['ngaykt']?>" placeholder="Đến ngày.." /></div>
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10">
    			<select name="sotien"  class="w-100 main_select select_danhmuc chzn-select">
    		...
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10">
    			<select name="tinhtrang"  class="w-100 main_select select_danhmuc chzn-select">
    		...
    		<div class="mycol-2 mycol-table-6 mycol-mobi-12 mb-table-10"><input type="submit" class="w-100 btn btn-info" value="Tìm kiếm"/></div>
    	</div>
    </form>
    <div class="clear"></div>
    </div><!--end tim kiem-->
...
<div class="control_frm" style="margin-top:10px;">
  	<div>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr class="tt_table">
       ...
       <td class="sortCol" width="140"><div>Mã đơn hàng<span></span></div></td>     
    ...
    <tbody>
        ...
        <td align="center"><?=$items[$i]['madonhang']?></td> 
        <td><?=$items[$i]['hoten']?></td>
		...
		?>
	     ...
	     <?=number_format($tongtiendonhang,0, ',', '.')?>&nbsp;vnđ
        	...
        	<td class="actBtns">
            	<a href="index.php?com=order&act=edit&id=<?=$items[$i]['id']?>&thanhpho_item=<?=$items[$i]['thanhpho']?>&thanhpho=<?=$items[$i]['quan']?>&phuong=<?=$items[$i]['phuong']?>&httt=<?=$items[$i]['httt']?>" title="" class="btn btn-info" original-title="Xem và sửa đơn hàng"><i class="fa fa-pencil"></i> Sửa</a>
            	<a href="" onclick="CheckDelete('index.php?com=order&act=delete&id=<?=$items[$i]['id']?>'); return false;" title="" class="btn btn-danger" original-title="Xóa đơn hàng"><i class="fa fa-times"></i> Xóa</a>
            </td>
      	</tr>
         <?php } ?>
    </tbody>
